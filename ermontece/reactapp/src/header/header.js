            ...
            <div className="collapse navbar-collapse" id="navbarColor02">
                ...
                <ul className="navbar-nav d-flex flex-row">
                    <li className="nav-item me-3 me-lg-0">
                        <a className="nav-link" href="https://www.youtube.com/@MonteceGamingChannel" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="nav-item me-3 me-lg-0">
                        <a className="nav-link" href="https://vk.com/montecegaming" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="nav-item me-3 me-lg-0">
                        <a className="nav-link" href="https://discord.gg/YVCHJTXfKr" target="_blank" rel="noopener noreferrer">
                            <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="11.5" cy="11.5" r="11.5" fill="#39E639"/>
